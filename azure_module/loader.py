...
class loader:
    ...
    def load_data(self):
        ...
        self.logger.debug("Column names after cleaning: " + ", ".join(df.columns))

        base_url = 'mysql+pymysql://{0}:{1}@{2}:{3}'.format('root', 'password', 'localhost', '3306')
        ...
        try:
            ...
            self.logger.info(f'Start inserted into table {table_name}')
